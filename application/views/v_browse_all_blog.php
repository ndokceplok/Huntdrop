...
<?php $this->load->view('includes/header.php');?>
            	...
            	<div class="box">
                	...
                	<div class="box-heading red">
                        <h1><span class="title fl">Blogs <?php if(!empty($tag)){ echo ' with tag "'.$tag.'"';}?></span></h1>
                    </div>

                    <div class="content_container box-content">
                        <p class="stat_bar">
                        	
                            <a <?php if($sort=="latest"){?> class="selected" <?php } ?> href="<?php echo base_url();?>blog<?php echo $add;?>" >Most Recent</a> 
                            <a <?php if($sort=="view"){?> class="selected" <?php } ?> href="<?php echo base_url();?>blog<?php echo $add;?>/by/view">Most Viewed</a> 
                            <a <?php if($sort=="active"){?> class="selected" <?php } ?> href="<?php echo base_url();?>blog<?php echo $add;?>/by/active" >Most Discussed</a> 
                            <a <?php if($sort=="popular"){?> class="selected" <?php } ?> href="<?php echo base_url();?>blog<?php echo $add;?>/by/popular"  >Most Favorited</a> 
                        </p>

                        <div class="content_sidebar fl">
                            <h2>TOP BLOGGERS</h2>
                            <ul>
                            <?php foreach($top_bloggers as $r){ ?>
                            
                                <li><a href="<?php echo base_url();?>blog/<?php echo $r->user_name;?>"><?php echo $r->user_name;?></a> (<?php echo $r->total_blogs;?>)</li>
                        ...
                        <div class="content_box">
                            ...
                            ?>
                            <p class="no-item">There are no blogs yet. <a href="<?php echo base_url().$blog_link;?>">Create one</a></p>
                            <?php }else{ ?>
