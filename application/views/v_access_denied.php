...
<?php $this->load->view('includes/_meta.php');?>
        ...
        <div id="signin_menu">
			<?php if($this->session->userdata('logged_in')){?>
                ...
                <ul class="hidden member_nav">
                    ...
                    <li><?=anchor('member/forum/create', 'New Forum Topic', (isset($active) && $active=='forum')?'class="active"':'')?></li>
                    ...
                    <li><?=anchor('member/friend', 'Friends', (isset($active) && $active=='friend')?'class="active"':'')?></li>
    ...
    <div id="content">
        ...
        <div id="main_section">
	        ...
	        <h2 class="center">Sorry! You have no permission to access that page.</h2>
