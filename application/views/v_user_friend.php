            	...
            	<div class="box">
                    ...
                    <div class="content_container box-content">
                        <p class="stat_bar">
                            ...
                            <a href="<?php echo base_url();?>user/<?php echo $account->user_name;?>">Profile</a>
                        </p>
                    

                        <p>These are the hunters that <a href="<?php echo base_url();?>user/<?php echo $account->user_name;?>"><?php echo $account->user_name;?></a> follows:</p>
