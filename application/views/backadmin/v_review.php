...
<?php $this->load->view('includes/backadmin/header.php');?>
	...
	<div id="content">
        ...
        <div id="main_section">
            ...
            <h1>reviews <?php echo !empty($keyword)?'with keyword "'.$keyword.'"':'';?></h1>
            <div id="section_left">
                ...
                <table class="lists" width="100%">
                    ...
                    <?php foreach($reviews as $i=>$r){ ?>
                    	<tr>
                        	...
                        	<td><a href="<?php echo base_url().'review/'.$r->review_id.'/'.pretty_url($r->title);?>" target="_blank"><img src="<?php echo content_thumb($r->thumb);?>" height="60" /></a></td>
                        	<td><a href="<?php echo base_url().'review/'.$r->review_id.'/'.pretty_url($r->title);?>" target="_blank"><?php echo $r->title;?></a></td>
                        	...
                        	<td><a href="<?php echo $admin_link.'review/update/'.$r->review_id;?>">edit</a> <a class="delete" href="<?php echo $admin_link.'review/delete/'.$r->review_id;?>">del</a></td>
                        </tr>
                    <?php } ?>
                    </tbody>
                </table>
            ...
            <div id="section_right">
            	<h2>Actions</h2>
               	...
               	<?php echo form_open($admin_link.'review/search',array('class'=>'search_form'));?>
