...
<?php $this->load->view('includes/backadmin/header.php');?>
	...
	<div id="content">
        ...
        <div id="main_section">
            ...
            <h1>videos <?php echo !empty($keyword)?'with keyword "'.$keyword.'"':'';?></h1>
            <div id="section_left">
                ...
                <table class="lists" width="100%">
                    ...
                    <?php foreach($videos as $i=>$r){ ?>
                    	<tr>
                        	...
                        	<td><a href="<?php echo base_url().'video/'.$r->video_id.'/'.pretty_url($r->title);?>" target="_blank"><img src="<?php echo youtube_thumb($r->youtube_id);?>" height="60" /></a></td>
                        	<td><a href="<?php echo base_url().'video/'.$r->video_id.'/'.pretty_url($r->title);?>" target="_blank"><?php echo $r->title;?></a></td>
                        	...
                        	<td><a href="<?php echo $admin_link.'video/update/'.$r->video_id;?>">edit</a> <a class="delete" href="<?php echo $admin_link.'video/delete/'.$r->video_id;?>">del</a></td>
                        </tr>
                    <?php } ?>
                    </tbody>
                </table>
            ...
            <div id="section_right">
            	<h2>Actions</h2>
               	...
               	<?php echo form_open($admin_link.'video/search',array('class'=>'search_form'));?>
