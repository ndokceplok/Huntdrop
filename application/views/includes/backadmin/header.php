	<div id="sidebar">
		<h1 ><a href="<?php echo $admin_link;?>"><img src="<?php echo assets_url().'images/logo.jpg';?>" alt="Huntdrop" title="Huntdrop"></a></h1>
    	
        <?php if(userdata('admin_logged_in')){?>
        <div>
            <p>You are logged in as : <strong><?php echo userdata('admin_user_name');?></strong>
            <a class="btn" target="_blank" href="<?php echo base_url();?>">View Homepage</a></p>
        ...
        <ul id="nav" class="clear">
            ...
            <li><a <?php if(isset($active) && $active=='admin'){?>class="active" <?php } ?> href="<?php echo $admin_link;?>admin">Admins</a></li>
